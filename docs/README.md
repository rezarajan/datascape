...
| `plans/02-week-two.md` | Plan | Managed seam proof: `placement: managed` → tofu-controller Terraform CR → Neon free tier (real endpoint); Flux-path harness wiring. **APPROVED, at Revision 2 2026-07-26** (local-bootstrap directive superseded after slice-1 findings — reversal recorded). |
