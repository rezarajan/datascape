...
| `plans/04-week-four.md` | Plan | The mesh is the substrate: compiled egress at declared endpoints (declare + deny enforced, contract over plan-deferral), mesh-mandatory managed scenario, isolated quickstart sequences + companion WALKTHROUGH. **APPROVED Revision 1, 2026-07-26.** |
