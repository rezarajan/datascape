...
| `plans/02-week-two.md` | Plan | Managed seam proof: `placement: managed` → tofu-controller Terraform CR → Neon; Flux-path harness wiring. **DRAFT — awaiting owner approval.** |
